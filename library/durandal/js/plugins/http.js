...
define(['jquery', 'knockout','config'], function ($, ko,config) {
    ...
    return {
        ...
        getList: function (url, data, pageSize, pageIndex, orderItem, callbackFunc,getDataCount) {
            var pageParameter = {};
            pageParameter.pageSize = pageSize;
            pageParameter.pageIndex = pageIndex;
            if (orderItem != undefined && orderItem != "") {
                pageParameter.orderBy = orderItem;
            }
            if (getDataCount != undefined && getDataCount) {
                pageParameter.getItemCount = true;
            }
            data.pageParameter = ko.toJSON(pageParameter);
            data.rd = Math.random();
            url = config.baseServerUrl + url;
            $.ajax({
                url: url,
                data: data,
        ...
        getListPost: function (url, data, pageSize, pageIndex, orderItem, callbackFunc, getDataCount) {
            var pageParameter = {};
            pageParameter.pageSize = pageSize;
            pageParameter.pageIndex = pageIndex;
            if (orderItem != undefined && orderItem != "") {
